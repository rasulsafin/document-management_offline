namespace MRS.DocumentManagement.Connection.Tdms.Helpers
{
    public static class ObjectTypeID
    {
        ...
        public static readonly string FIX = "OBJECT_FIX";
        public static readonly string CHECK_LIST = "OBJECT_CHECKLIST";
        public static readonly string BUILD_DOCUMENT = "OBJECT_BUILDDOC";
