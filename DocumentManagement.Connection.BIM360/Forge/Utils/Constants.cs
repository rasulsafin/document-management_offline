...
namespace MRS.DocumentManagement.Connection.Bim360.Forge
{
    public static class Constants
    {
        ...
        internal static readonly Lazy<EnumerationTypeExternalDto> STANDARD_NG_TYPES = new (()
        ...
        internal static readonly EnumerationValueExternalDto UNDEFINED_NG_TYPE = new ()
        {
