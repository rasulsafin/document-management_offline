...
namespace MRS.DocumentManagement.Tests
{
    ...
    public class SynchronizerObjectiveTests
    {
        ...
        public async Task Synchronize_LocalAndRemoteObjectiveChangeParent_ChangeParentAtRemoteAndSynchronizedObjectives()
        {
            ...
            // Local changed
            var localAndSynchronizedParentId = objectiveLocal.ParentObjectiveID = existingObjective.ID;
        ...
        private async Task<(Objective local, Objective synchronized, ObjectiveExternalDto remote)> ArrangeObjective()
        {
            var objectiveLocal = MockData.DEFAULT_OBJECTIVES[0];
